...
train  = pd.read_csv('/home/rigone/Dropbox/Workspace/On_GitHub/Auxilary/Large_Input/Cancer/training/training_variants')
trainx = pd.read_csv('/home/rigone/Dropbox/Workspace/On_GitHub/Auxilary/Large_Input/Cancer/training/training_text',sep = '\|\|', engine= 'python', header=None,
                     skiprows=1, names=["ID","Text"])
train  = pd.merge(train, trainx, how = 'left', on = 'ID').fillna('')
print(train.head())

test  = pd.read_csv('/home/rigone/Dropbox/Workspace/On_GitHub/Auxilary/Large_Input/Cancer/testing/stage2_test_variants.csv')
testx = pd.read_csv('/home/rigone/Dropbox/Workspace/On_GitHub/Auxilary/Large_Input/Cancer/testing/stage2_test_text.csv',sep = '\|\|', engine= 'python', header=None,
                     skiprows=1, names=["ID","Text"])
